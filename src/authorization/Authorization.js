    ...
    return (
      <div className="form">
        <div className="form__header">
          <div className="form__header-lock">
            <svg
              ...
              height="100"
              viewBox="0 0 50 50"
              className="form__header-lock-icon"
            >
        ...
        <form>
          ...
          <div className="form__check">
            <input type="checkbox" className="form__check-mark" />
            <div>Remember me</div>
          </div>
          <div>
            <button onClick={(e) => this.handleSubmit(e)} type="submit" className="form__signin">
              Sign in
            </button>
          </div>
        </form>
        <div className="form__footer">
          <div className="form__footer-buttons">Forgot password?</div>
          <Link to="/registration" className="form__footer-buttons">
            Don't have an account? Sign up
          </Link>
        </div>
        <div className="form__copyright">Copyright © Your website 2023</div>
      </div>
    );
  }
}
